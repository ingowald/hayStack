...
#if 1
    static bool testBarneyPlugins = (std::getenv("BARNEY_PLUGINS_TEST_TRIANGLES") != nullptr);
    anari::Geometry mesh
...
#if 1
    static bool testBarneyPlugins = (std::getenv("BARNEY_PLUGINS_TEST_UNSTRUCTURED") != nullptr);
    auto field  
